...
class Expv8_large(BaseModel):
    def __init__(self, params):
        ...
        self.grad_cache = {}
        ## 수정
        self.interp_ratio = 20
        self.real_interp = 5
        self.end_tlist = [3,7,11,15]
    ...
    def net_validation(self, data_in, epoch):
        ...
        for n in range(recon.shape[1]):
            ...
            self.toim(recon[0, n].detach().cpu().clamp(0, 1)).save(os.path.join(self.val_im_path, str(epoch), f"{folder}_{rgb_name[0][0]}_{n}_res.jpg"))
